...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0218688814f3a132: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hdfb3f8470b6e288d: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hd9047163655ea713: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__hf0d2fbce5e37e975: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_4: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h10ed2f9b69b8a5af_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2b76460ec8b3b9f6: (a: number, b: number, c: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2fa51b51e517bbd9: (a: number, b: number) => number;
    readonly wasm_bindgen__convert__closures_____invoke__ha46cfec17c58cfce: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h235191981a82163f: (a: number, b: number) => void;
