...
use crate::{
    ...
    utils::{
        ...
        objects::{DoorWinEntities, RoundStartTimestamp, GameStateLocal, GameConditions, PreloadedTextures, RenderTargetImage, FixedFullscreenActive, TexturePreloadManifest, TexturePreloadState},
...
pub fn build_app() -> App {
    ...
    .insert_resource(TexturePreloadManifest::default())
    .insert_resource(TexturePreloadState::default())
